...
public class Configuration {
	static String xml_revision = "1.1.5";
	static final String timeout = "7200";
	static boolean withFolder = false;
	...
	static String[] neTypes = {"7090M5","7090M8","7090M80","7090M92","7090M240","7090M240-1","7090CEM60","7090CEM100","7090CEM2"};
	static String[] ethTypes = {"fe","fx","ge","xg","gee","lb","cg"};
	...
	static final String [][] callMetadata = {
		{"ne", "restoredb", "ignoreColor=true,poundNumber=1"},
		{"ne", "reboot", "ignoreColor=true"}
	};
	
	static String [] getCallMetaData (String fName, String actionName) {
		for (String [] item:callMetadata) {
			if (item[0].equals(fName) && item[1].equals(actionName))
				return item;
		}
		return null;
	}
	...
	static final String [][] callParameterTable = {//fname,action,parameter,parameter type, range,other
		...
		{"@proc/@persvr","clearcurper","brd","U32","1-16",""},
		{"@proc/@persvr","clearcurper","period","enum","m15/h24",""},
		{"@proc/@persvr","clearcurper","objlist","TXT","","vclosedby=3"},
		{"@proc/@persvr","getcurper","brd","U32","1-16",""},
		{"@proc/@persvr","getcurper","period","enum","m15/h24",""},
		{"@proc/@persvr","getcurper","objlist","TXT","","vclosedby=3"},
		{"@proc/@nepkg","upgradefrom","card","TXT","",""},
		{"@proc/@nepkg","upgradefrom","src","TXT","","vclosedby=1"},
		{"@proc/@nepkg","upgradefrom","pkgname","TXT","",""},
		...
		{"ne","exportdb","dbname","enum","odc/secu",""},
		{"ne","exportdb","tofile","TXT","",""},
	...
	static final String[][] nameMapper = {
		...
		{"@protocols/@neighbour/@list", "protocols_neighbour_list"},	
		{"@protocols/@neighbour/@obj",  "protocols_neighbour_obj"},
	...
	public static final int ALL_STATIC = 2;
	
	public static String getTypeString(int type) {
		switch (type) {
		case ALL_DYNAMIC:
			return "allDyn";
		case ONE_STATIC_ONE_DYNAMIC:
			return "1to1";
		case ALL_STATIC:
			return "allSta";
		}
	...
	static String [][] actions = {
		{"ne","set_context","acttype=internal,isNode=true"},
		{"ne","popDataFromDriver","acttype=2,actfunc=4"}
	};
	
	static String [][] actionDefinitions = {
		{"ne","set_context","user-id","string","",""},
		{"ne","set_context","password","string","",""},
		{"ne","set_context","user-prompt","string","",""},
		{"ne","set_context","password-prompt","string","",""},
		{"ne","set_context","login-ok-prompt","string","",""},
		{"ne","set_context","__nameValuePair","format","name::value",""},
		{"ne","popDataFromDriver","resp","","",""},
		{"ne","popDataFromDriver","__timeout","integer","11-"+Configuration.timeout,""},
		{"ne","popDataFromDriver","__prompt","string","",""},
		{"ne","popDataFromDriver","__poundNumber","integer","1..4",""}
	};
	...
	static Vector <String[]> getActionDefinition(String fName, String actionName) {
		Vector <String[]> result = new Vector<String[]>();
		for (String [] act:actionDefinitions) {
			if (act[0].equals(fName) && act[1].equals(actionName)) {
				result.add(act);
			}
		}
		return result;
	...
	static String [][] functionDefinitions = {
		...
		{functionNames[1],"object","string","",""},
		{functionNames[1],"attributeName","string","",""},
		{functionNames[2],"object","string","",""},
		{functionNames[3],"source","string","",""},
		{functionNames[3],"separator","enum","space/comma/semicomma/dot/input...",""},
		{functionNames[3],"column","integer","1..n",""},
		{functionNames[4],"source","string","",""},
		{functionNames[4],"separator","enum","space/comma/semicomma/dot/input...",""},
		{functionNames[4],"key","string","",""},
		{functionNames[5],"source","string","",""},
		{functionNames[5],"separators","format","comma,:,space",""},
		{functionNames[5],"columns","format","2,3,1",""},
	};
	...
	static String[][] hierarchyObjects = {
		{"@ptn/@l2vpn/@elan/@obj","l2vpn/elan","ne"},
		{"@ptn/@l2vpn/@eline/@obj","l2vpn/eline","ne"},
		{"@ptn/@l2vpn/@etree/@obj","l2vpn/etree","ne"},
		{"@ptn/@pmap/@llsp_obj","pmap/mpls","ne"},
		{"@ptn/@pmap/@elsp_obj","pmap/mpls","ne"},
		{"@ptn/@pmap/@eelsp_obj","pmap/mpls","ne"},
		{"@pmap/@vlanpri_obj","pmap/ethac","ne"},
		{"@pmap/@l2pmapc_obj","pmap/ethac","ne"},
		{"@pmap/@l3pmapc_obj","pmap/ethac","ne"},
		{"@ptn/@interfaces/@track/@obj","interfaces/track","ne"},
		{"@ptn/@interfaces/@acn/@obj","interfaces/acn","ne"},
		{"@ptn/@interfaces/@l3vpnpeer/@obj","interfaces/l3vpnpeer","ne"},
		{"@ptn/@interfaces/@pwsdh/@obj","interfaces/pwsdh","ne"},
		{"@ptn/@interfaces/@tunnel/@obj","interfaces/tunnel","ne"},
		{"@ptn/@interfaces/@pweth/@obj","interfaces/pweth","ne"},
		{"@ptn/@interfaces/@pwpdh/@obj","interfaces/pwpdh","ne"},
		{"@ptn/@interfaces/@veth/@l3obj","interfaces/vethl3","ne"},
		{"@ptn/@interfaces/@veth/@l2obj","interfaces/vethl2","ne"},
		{"@interfaces/@mcn/@obj","interfaces/mcn","ne"},
		{"@ptn/@interfaces/@peergrp/@obj","interfaces/peergrp","ne"},
		{"@ptn/@interfaces/@vrrpgrp/@obj","interfaces/vrrpgrp","ne"},
		{"@ptn/@interfaces/@lag/@obj","interfaces/lag","ne"},
		{"@ptn/@interfaces/@veg/@obj","interfaces/veg","ne"},
		{"@ptn/@interfaces/@vlsec/@obj","interfaces/vlsec","ne"},
		{"@ptn/@interfaces/@ccn/@obj","interfaces/ccn","ne"},
		{"@ptn/@l3vpn/@obj","cfp","ne"},
		{"@proc/@logsvr","proc","ne"},
		{"@proc/@nepkg","proc","ne"},
		{"@proc/@persvr","proc","ne"},
		{"@proc/@almsvr","proc","ne"},
		{"@proc/@secu","proc","ne"},
		{"@ptn/@ces/@obj","ces","ne"},
		{"@protocols/@cfp/@cfp_obj","cfp","ne"},		
		{"@acl/@obj","acl","ne"},
		{"@cmap/@l2_obj","cmap","ne"},
		{"@cmap/@l3_obj","cmap","ne"},		
		{"@interfaces/@if_cos2vlanpri_obj","cos2vlanpri","ne"},		
		{"@ptn/@protocols/@bfd/@password","protocols/bfd/auth/simplepassword","ne"},
		{"@protocols/@static_route/@destination","protocols/static_route","ne"},
		{"@protocols/@route/@destination","protocols/route","ne"},
		{"@ptn/@protocols/@dual_home_prt/@dual_obj","protocols/dual","ne"},
		{"@ptn/@protocols/@vpaps/@obj","protocols/vpaps","ne"},
		{"@protocols/@msp/@msp_obj","protocols/msp","ne"},
		{"@ptn/@protocols/@pwaps/@obj","protocols/pwaps","ne"},
		{"@protocols/@lacp/@lacp","protocols","ne"},
		{"@protocols/@snmp/@snmptarget","protocols/snmp","ne"},
		{"@ptn/@protocols/@mpls/@llsp_clrtoexp_map","protocols/mpls/llsp/clrtoexp","ne"},
		{"@ptn/@protocols/@mpls/@llsp_exptoclr_map","protocols/mpls/llsp/exptoclr","ne"},
		{"@ptn/@protocols/@mpls/@elsp_phbtoexp_map","protocols/mpls/elsp/costoexp","ne"},
		{"@ptn/@protocols/@mpls/@elsp_exptophb_map","protocols/mpls/elsp/exptocos","ne"},
		{"@ptn/@protocols/@mpls/@eelsp_phbtoexp_map","protocols/mpls/eelsp/costoexp","ne"},
		{"@ptn/@protocols/@mpls/@eelsp_exptophb_map","protocols/mpls/eelsp/exptocos","ne"},		
		{"@ptn/@protocols/@mpls/@ring_obj","protocols/mpls/ring","ne"},
		{"@ptn/@protocols/@mpls/@xc_obj","protocols/mpls/xc","ne"},		
		{"@protocols/@cfm/@cfm_md","protocols/cfm","ne"},		
		{"@ptn/@protocols/@ndualhome/@obj","protocols/ndualhome","ne"},	
		{"@protocols/@ptp/@ptp","protocols","ne"},		
		{"@protocols/@ospf/@obj","protocols","ne"},
		{"@protocols/@ntp/@ntp","protocols","ne"},		
		{"@ptn/@ccc/@obj","ccc","ne"},		
		{"@perprofile/@perpdh","perprofile","ne"},
		{"@perprofile/@perstm1","perprofile","ne"},
		{"@perprofile/@pervc12","perprofile","ne"},
		{"@perprofile/@permpls","perprofile","ne"},
		{"@perprofile/@pereth","perprofile","ne"},
		{"@perprofile/@pwtdm","perprofile","ne"},
		{"@perprofile/@pervrf","perprofile","ne"},
		{"@ptn/@interfaces/@if_vlanpri2cng_obj","vlanpri2cng","ne"},
		{"@interfaces/@portisolationgrp","portisolationgrp","ne"}
	};
	public static void checkDuplicated(String[][] itemList) {
		for (int i=0; i<itemList.length; i++) {
			for (int j=i+1; j<itemList.length;j++) {
				if (itemList[i][0].equals(itemList[j][0])) {
					System.out.println(itemList[i][0]+ " is duplicated in list");
				}
			}
		}
	}
	public static String[] getHierarchy(String fName) {
		if (withFolder) return null;
		if (fName==null) return null;
		for (String [] item:hierarchyObjects) {
			if (fName.trim().equals(item[0]))
				return item;
		}
		return null;
	}
	
	public static String[][] getHierarchyObjects() {
		return hierarchyObjects;
	}
	
	static String [][] addTimeoutActionList = {//object
		{"@ptn/@cxt500e/@lg_line3", "set", "type"}
	};
	
	public static boolean isActionToAddTimeout(String fName, String actionName) {
		boolean result = false;
		for (String [] item:addTimeoutActionList) {
			if (item[0].equals(fName) && item[1].equals(actionName)) {
				result = true;
				break;
			}
